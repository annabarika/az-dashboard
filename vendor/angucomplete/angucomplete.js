...
angular.module('angucomplete', [] )
    ...
    return {
        ...
        '<div ng-if="imageField" class="angucomplete-image-holder"><img ng-if="result.image && result.image != \'\'" ng-src="http://back95.ru/f/catalogue/{{result.originalObject.id}}/{{result.originalObject.preview[1]}}" class="angucomplete-image"/>' +
